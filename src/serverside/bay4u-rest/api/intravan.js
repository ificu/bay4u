...
router.post('/',
  function(req, res, next){
      ...
      request({
        ...
        //uri: 'http://adbcp.goldauto.co.kr/apiCarinfoSK.aspx',
        uri: 'http://adbcp.intravan.co.kr/apiCarinfoSK.aspx',
        body: formData,
        method: 'POST'
        ...
        if(JSON.parse(body).result === "ok") {
          res.json({success:true, data: JSON.parse(body).car_vinary_no, type: JSON.parse(body).car_name + " " + JSON.parse(body).mover_type});
          res.end();
